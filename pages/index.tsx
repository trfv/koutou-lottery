...
const LotteryPage = () => {
  ...
  return (
    <Layout>
      <h2>はじめに</h2>
      <p>このサイトは<a href="https://sisetun.kcf.or.jp/web/" target="_blank" rel="noreferrer noopener">江東区の施設の抽選システム</a>を利用しやすくするためのものです。</p>
      <h2>機能の説明</h2>
      <p>以下の機能があります。</p>
      <ul>
      ...
      <p>抽選システムに表示されている抽選申し込み状況を取得するスクリプトを生成します。<a href="https://playwright.dev/" target="_blank" rel="noreferrer noopener">Playwright</a>というライブラリを利用し、画面をスクレイピングします。</p>
      <button onClick={handleToGenerate}>スクリプトを生成する</button>
      <h3>抽選申し込み状況分析機能</h3>
